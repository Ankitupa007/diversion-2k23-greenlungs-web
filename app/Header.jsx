...
export default function Header() {
    ...
    return (
        <nav className="w-full bg-white backdrop-blur-sm z-10">
            <div className="flex justify-between px-10 mx-auto py-4 lg:max-w-7xl md:px-8">
                ...
                <div>
                    ...
                    <div className="flex items-center justify-between py-3 md:py-5">
                        <Link href="/" className=" inline-flex py-3 px-5 rounded-lg items-center hover:text-green-500 focus:outline-none">
