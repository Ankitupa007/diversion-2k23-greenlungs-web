...
export const metadata = {
  title: 'Greenlungs',
  description: 'Join or organize plantation events',
}
    ...
    <html lang="en">
      ...
      <body>
        ...
        <div className="isolate -z-10">
          <div className="fixed inset-x-0 top-[-10rem] transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]">
            <svg
            ...
            >
              ...
              <defs>
                ...
                >
                  ...
                  <stop offset={1} stopColor="#3CCD63" />
                </linearGradient>
              </defs>
            </svg>
          </div>
